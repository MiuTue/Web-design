...
function generateFoodPosition(){
    while (true){
        ...
        for (let segments of snake) {
            if (segments.x === newFoodPosition.x && segment.y === newFoodPosition.y) {
...
//Check for the collisions with wall or self
...
//Restart game when restart buttonclicked
...
//Resume the game when window gain focus
